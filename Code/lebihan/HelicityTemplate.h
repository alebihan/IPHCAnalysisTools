#ifndef HelicityTemplate_h
#define HelicityTemplate_h
...
class HelicityTemplate : public Selection {

 public:
  HelicityTemplate(TString Name_, TString id_);
  virtual ~HelicityTemplate();
