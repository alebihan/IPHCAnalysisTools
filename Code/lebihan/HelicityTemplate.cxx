...
HelicityTemplate::HelicityTemplate(TString Name_, TString id_):
  Selection(Name_,id_),
  cMu_pt(20),
  cMu_eta(2.1),
  cTau_pt(20),
...
HelicityTemplate::~HelicityTemplate(){
...
void  HelicityTemplate::Configure(){
  // Setup Cut Values
...
void  HelicityTemplate::Store_ExtraDist(){ 
...
void  HelicityTemplate::doEvent(){ //  Method called on every event
